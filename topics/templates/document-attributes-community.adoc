:project_name: Aerobase
:project_name_full: Aerobase
:project_community: true
:project_product: false
:project_version: 2.4.0
:project_versionMvn: 2.4.0
:project_versionNpm: 2.4.0
:project_versionDoc: 2.4
:project_images: aerobase-images
...
:apidocs_javadocs_link: https://docs.aerobase.io/apis/rest/
:apidocs_adminrest_name: Administration REST API
:apidocs_adminrest_link: https://docs.aerobase.io/apis/rest/
